      ...
      <div className='testito'>
        <form className='Form'>
          ...
          <div className='Alertas'>
            ...
            />
            {emptyEmail ? (
              <span className='alerta'>Escriba un correo</span>
            ) : undefined}
          </div>
          <div className='Flex-X'>
            <div className='Alertas'>
              ...
              />
              {emptyPassword ? (
                <span className='alerta'>Escriba una contraseña</span>
              ) : undefined}
              {verification ? <MessageEmail /> : undefined}
              {!isValidPassword ? (
                <span className='alerta'>Ingrese una contraseña valida</span>
              ) : undefined}
            </div>
          ...
          <button onClick={signUpNewUser} className='espacio'>
            Registrarse
          </button>
        </form>
      </div>
